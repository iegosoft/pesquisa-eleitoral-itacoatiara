...
[`TP1-MANUT-CORRETIVA/docs/apresentacao-sistema.md`](apresentacao-sistema.md) e [`TP1-MANUT-CORRETIVA/docs/descricao-sistema.md`](descricao-sistema.md).
...
- **oxlint** (análise estática, diferencial opcional) — rodado sobre todo o código-fonte antes da
  entrega: 0 warnings e 0 errors em 57 arquivos. Detalhe em [`TP1-MANUT-CORRETIVA/docs/bugs-e-classificacao.md`](bugs-e-classificacao.md).
...
como não aplicáveis, em [`TP1-MANUT-CORRETIVA/docs/bugs-e-classificacao.md`](bugs-e-classificacao.md).
...
|---|---|
| Choze (`joseandrevianajunior`) | `TP1-MANUT-CORRETIVA/docs/apresentacao-sistema.md`, `.github/ISSUE_TEMPLATE/bug_report.md`, revisor e aprovador dos 4 PRs de correção |
| Luiz (`ghostsuki`) | `TP1-MANUT-CORRETIVA/docs/bugs-e-classificacao.md` |
